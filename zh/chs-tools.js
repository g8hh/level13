...
var cnItems = {
    ...
    "Add a chance that defenders (soldiers) get killed or buildings damaged during raids": "增加袭击期间防御者（士兵）被杀或建筑物受损的几率",
    "Add breaking and repairing items": "添加损坏和修理项目",
    "Add investigate action and insight stat": "添加调查操作和洞察统计",
    "Add luxury resources and outposts": "添加豪华资源和前哨站",
    "Add milestones and limits to evidence / rumour / favour accumulation based on milestones": "根据里程碑添加里程碑和对证据/谣言/支持积累的限制",
    "Add more follower types": "添加更多关注者类型",
    "Add more permanent and temporary effects (tired, blessed, varied injuries": "添加更多永久和临时效果（疲劳、祝福、各种伤害",
    "Add simple ending": "添加简单结局",
    "Add study at library action": "在图书馆行动中添加学习",
    "Add worker robots": "添加工人机器人",
    "Adjust costs and checks to make the start a little bit easier": "调整成本和检查，让起步更容易一些",
    "Allow building a barracks regardless of camp population": "无论营地人口多少，都允许建造营房",
    "Fix a few issues related to fight and hazard balancing": "修复一些与战斗和危险平衡相关的问题",
    "Fix error when using a First Aid Kit": "修复使用急救箱时的错误",
    "Fix several issues with world generation and fight balancing that could cause soft locks": "修复了世界生成和战斗平衡方面可能导致软锁的几个问题",
    "Improve the map (modes, readability fixes and layout improvements": "改进地图（模式、可读性修复和布局改进",
    "Make some debuffs (hunger, thirst, cold, poison, radiation) more forgiving by adding them slowly instead of immediately": "通过缓慢而不是立即添加来使一些减益效果（饥饿、口渴、寒冷、毒药、辐射）更加宽容",
    "Many smaller UI improvements": "许多较小的 UI 改进",
    "Other bugfixes": "其他错误修复",
    "Remove many repetitive log messages and add some new ones": "删除许多重复的日志消息并添加一些新的日志消息",
    "": "",
    "": "",
    "": "",
    "": "",
